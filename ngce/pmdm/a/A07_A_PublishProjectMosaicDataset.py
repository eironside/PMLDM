...
if __name__ == '__main__':
    jobID = sys.argv[1]
    serverConnectionFile = sys.argv[2] #.replace('aiotxftw6na01data', 'aiotxftw6na01') #Added replace 3 April 2019 BJN
    serverFunctionPath = sys.argv[3] #.replace('aiotxftw6na01data', 'aiotxftw6na01') #Added replace 3 April 2019 BJN
